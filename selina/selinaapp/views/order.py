...
class OrderViewSet(GenericViewSet):
    ...
    def get_orders(self, request):
        ...
        for order in orders:
            ...
            # rest_user = {
            #     'id': order.cart_group.seller.id,
            #     'email': order.cart_group.seller.email,
            #     'fullname': order.cart_group.seller.fullname,
            #     'phone': order.cart_group.seller.phone,
            #     'address': order.cart_group.seller.address,
            #     'gender': order.cart_group.seller.gender,
            #     'avatar_url': order.cart_group.seller.avatar_url,
            #     'user_type': order.cart_group.seller.user_type,
            # }
